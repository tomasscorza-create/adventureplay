...
import volcanicM3AlertUrl from "../../../assets/enemies/active-volcano-m3/alert.png";
import volcanicM3AttackUrl from "../../../assets/enemies/active-volcano-m3/attack.png";
import volcanicM3AttackWindupUrl from "../../../assets/enemies/active-volcano-m3/attack-windup.png";
import volcanicM3DefeatUrl from "../../../assets/enemies/active-volcano-m3/defeat.png";
import volcanicM3IdleUrl from "../../../assets/enemies/active-volcano-m3/idle.png";
import volcanicM3Run1Url from "../../../assets/enemies/active-volcano-m3/run-1.png";
import volcanicM3Run2Url from "../../../assets/enemies/active-volcano-m3/run-2.png";
...
export function loadSceneAssets(scene: Phaser.Scene): void {
    ...
    scene.load.image("volcanic-m3-idle", volcanicM3IdleUrl);
    scene.load.image("volcanic-m3-run-1", volcanicM3Run1Url);
    scene.load.image("volcanic-m3-run-2", volcanicM3Run2Url);
    scene.load.image("volcanic-m3-alert", volcanicM3AlertUrl);
    scene.load.image("volcanic-m3-attack-windup", volcanicM3AttackWindupUrl);
    scene.load.image("volcanic-m3-attack", volcanicM3AttackUrl);
    scene.load.image("volcanic-m3-defeat", volcanicM3DefeatUrl);
