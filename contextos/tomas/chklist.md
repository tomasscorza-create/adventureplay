...
- [ ] **Sistema Bilingüe Nativo Escalonable:** Arquitectura i18n completa para soportar inglés de forma sólida sin traducciones parcheadas. Implica barrido profundo de UI y reestructuración de la capa de datos estáticos (`data/`).
