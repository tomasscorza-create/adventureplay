...
export const puzzleLevelDefinitions: Record<string, PuzzleLevelDefinition> = {
  ...
  trialChamber2: {
    ...
    platforms: [
      ...
      { x: 2300, y: 500, width: 100, height: 24 },
      { x: 2450, y: 350, width: 150, height: 24 },
      { x: 2650, y: 150, width: 100, height: 490 },
    ],
    coins: [
    ...
    boxJumpZones: [{ x: 1015, y: 625, width: 76 }, { x: 2520, y: 335, width: 76 }],
    seals: [
      { x: 2110, y: 500, width: 52, height: 140 },
      { x: 2670, y: 10, width: 52, height: 140 },
    ],
    hazards: [
  ...
  trialChamber3: {
    ...
    platforms: [
      ...
      { x: 2350, y: 520, width: 150, height: 24 },
      { x: 2550, y: 400, width: 150, height: 24 },
      { x: 2750, y: 280, width: 40, height: 360 },
      { x: 2790, y: 280, width: 400, height: 24 },
      { x: 2790, y: 500, width: 150, height: 24 },
    ],
    coins: [
    ...
    seals: [
      ...
      { x: 3050, y: 130, width: 54, height: 150 },
      { x: 2820, y: 350, width: 54, height: 150 },
    ],
    hazards: [
      { x: 870, y: 610, width: 105, height: 30, damage: 1 },
      { x: 2170, y: 610, width: 120, height: 30, damage: 1 },
      { x: 2550, y: 610, width: 150, height: 30, damage: 1 },
      { x: 3250, y: 610, width: 100, height: 30, damage: 1 },
    ],
    inventoryReward: {
  ...
  trialChamber4: {
    ...
    platforms: [
      ...
      { x: 2350, y: 490, width: 150, height: 24 },
      { x: 2600, y: 350, width: 250, height: 24 },
      { x: 3150, y: 380, width: 100, height: 260 },
      { x: 3250, y: 380, width: 270, height: 24 },
      { x: 3600, y: 500, width: 150, height: 24 },
    ],
    coins: [
    ...
    boxJumpZones: [{ x: 1215, y: 625, width: 68 }, { x: 2450, y: 475, width: 68 }],
    seals: [
      { x: 1900, y: 490, width: 54, height: 150 },
      { x: 2150, y: 490, width: 54, height: 150 },
      { x: 2650, y: 200, width: 54, height: 150 },
      { x: 3180, y: 230, width: 54, height: 150 },
    ],
    hazards: [
      { x: 900, y: 610, width: 110, height: 30, damage: 1 },
      { x: 2250, y: 610, width: 100, height: 30, damage: 1 },
  ...
  trialChamber5: {
    ...
    playerStart: { x: 150, y: 560 },
    platforms: [
      { x: 0, y: 640, width: 6000, height: 80 },
      ...
      { x: 3850, y: 400, width: 150, height: 24 }, // Platform A
      { x: 4500, y: 500, width: 150, height: 24 }, // Step 1
      { x: 4700, y: 350, width: 40, height: 290 }, // Wall
      { x: 4740, y: 350, width: 260, height: 24 }, // Platform C
    ],
    coins: [
    ...
    boxJumpZones: [{ x: 3830, y: 625, width: 68 }],
    ...
    plates: [
      ...
      { id: "plate-3", x: 4300, y: 625, width: 80 },
    ],
    levers: [
    ...
    gates: [
      ...
      { id: "gate-4", x: 5100, y: 0, width: 50, height: 640, requiredActivations: ["plate-3"] },
    ],
    seals: [
      { x: 3900, y: 280, width: 50, height: 120 },
      { x: 4850, y: 230, width: 50, height: 120 },
      { x: 4850, y: 520, width: 50, height: 120 },
    ],
    hazards: [
      ...
      { x: 4400, y: 610, width: 100, height: 30, damage: 1 },
    ],
    inventoryReward: {
    ...
    goal: { x: 5800, y: 560 },
    requiredActivations: ["plate-1", "lever-1", "plate-2", "lever-dist", "plate-3"],
    supportsCooperative: true,
    visualTheme: {
  ...
  trialChamber6: {
    ...
    playerStart: { x: 150, y: 560 },
    platforms: [
      { x: 0, y: 640, width: 5500, height: 80 },
      ...
      { x: 4450, y: 340, width: 60, height: 24 },
      { x: 4650, y: 220, width: 60, height: 24 },
      { x: 4850, y: 100, width: 150, height: 24 },
      { x: 5100, y: 0, width: 40, height: 200 },
      { x: 5100, y: 350, width: 40, height: 290 },
    ],
    coins: [
    ...
    seals: [
      { x: 4900, y: -20, width: 50, height: 120 },
      { x: 5095, y: 200, width: 50, height: 150 },
    ],
    hazards: [
  ...
  trialChamber7: {
    ...
    platforms: [
      ...
      { x: 5070, y: 500, width: 100, height: 24 },
      { x: 5350, y: 340, width: 50, height: 24 },
      { x: 5500, y: 200, width: 50, height: 24 },
      { x: 5650, y: 60, width: 200, height: 24 },
      { x: 6000, y: 0, width: 40, height: 300 },
      { x: 6000, y: 440, width: 40, height: 200 },
    ],
    coins: [
    ...
    boxJumpZones: [{ x: 1450, y: 625, width: 72 }, { x: 5250, y: 465, width: 72 }],
    seals: [
      { x: 2100, y: 500, width: 52, height: 140 },
      { x: 5750, y: -80, width: 52, height: 140 },
      { x: 5996, y: 300, width: 52, height: 140 },
    ],
    hazards: [
      { x: 950, y: 610, width: 120, height: 30, damage: 1 },
